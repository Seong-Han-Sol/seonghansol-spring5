 ...
 */
public class Step1 {
	public	void Step1() {//클래스명과 같은 이름의 메서드를 생성자 메서드를 자동으로 만들어 집니다.
		//자동으로 만들어진다.
	...
	public static void main(String[] args) {
		...
		printMember(names, ages, PhoneNums);//메서드 1번 호출하면 3명이 모두 출력
		//메서드명이 같음. 단, 로드된 파라미터 다른 메서드를 호출=오버로드
	}
	
	private static void printMember(String[] names, int[] ages, String[] phoneNums) {
		// for 반복문으로 3개를 한번에 출력
		int dataLength = names.length;
		for(int i=0;i<dataLength;i++) { //고전적인 for문
