...
SELECT deptno as "부서번호" FROM emp; --사원수대로 부서번호가 필요한 경우
SELECT DISTINCT deptno AS "부서번호" FROM emp;
-- 문자열을 연결할 때 concat 함수외에 ||파이프라인 2개를 겹쳐서 구현
